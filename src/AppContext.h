...
public:
    ...
    {
        std::wstring name = CredentialManager::BuildFullTargetName(m_prefix, command.m_name);
    ...
    {
        std::wstring filter = CredentialManager::BuildFullTargetName(m_prefix, command.m_name);
